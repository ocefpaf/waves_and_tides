...
\logo{\includegraphics[scale=0.25]{./figures/unimonte.png}}
...
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{./figures/dsc02996.jpg}}
\begin{frame}
...
\begin{frame}
    \frametitle{Espectro}
    \begin{center}
        \includegraphics[scale=0.4]{./figures/spectro.png}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[scale=0.4]{./figures/wave_prop.png}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[scale=0.7]{./figures/wave_energy.jpg}
            \end{center}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{center}
                \includegraphics[width=\columnwidth]{./figures/wave_generator.png}
            \end{center}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{center}
...
{% Imagem de fundo local.
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{./figures/osu_buoy.png}}
\begin{frame}
    \frametitle{Fim!}
        \begin{center}
            Perguntas?
