...
\]
Quanto maios a frequência (menor o período) mais rápidas serão as ondas.  Já
quanto menos o número de onda (maior o comprimento), mais lentas serão as ondas.
\end{solution}
...
Nossa velha conhecida que diz que as ondas de gravidade têm frequência angular
(período) muito maior (muito menor) que a frequência (período) inercial.


Agora imaginei uma onda muito longa com frequência muito baixa, como as ondas de
...
Discuta a diferença e semelhança entre essas suas em usando a equação, explique
a afirmação:
...
Assumindo que as Ondas de Rossby
tem a dimensão em $x$ muito maior que a dimensão em $y$ (o que significa $l=0$),
como podemos simplificar ainda mais a relação de dispersão de Ondas de Rossby
Curtas?
